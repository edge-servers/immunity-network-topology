...
from immunity_network_topology.tasks import handle_update_topology
...
class TestApi(
    ...
    @patch('immunity_network_topology.tasks.handle_update_topology.delay')
    ...
    @patch('immunity_network_topology.tasks.logger.warning')
