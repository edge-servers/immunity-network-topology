...
class ImmunityTopologyDeviceConfig(AppConfig):
    name = 'immunity_network_topology.integrations.device'
    ...
    def override_node_label(self):
        import_module('immunity_network_topology.integrations.device.overrides')
