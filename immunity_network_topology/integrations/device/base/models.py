...
trigger_device_checks_path = 'immunity_monitoring.device.tasks.trigger_device_checks'
...
class AbstractDeviceNode(UUIDModel):
    ...
    def trigger_device_updates(cls, link):
        ...
        for device_node in cls.filter_by_link(link):
            ...
            # triggers monitoring checks if Immunity Monitoring is enabled
            if 'immunity_monitoring.device' in settings.INSTALLED_APPS:
